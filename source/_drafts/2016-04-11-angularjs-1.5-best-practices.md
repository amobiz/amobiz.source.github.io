...
可以看到，雖然 provider 的彈性最大，也能提供 config 功能，但是如下一段建議所言，config 功能有很多方式可以達成，因此並沒有非使用 provider 不可的理由。而 service，由於強制必須提供 constructor，所以服務本身只能是物件類型，彈性上多少受到一些限制。基於這些理由，多數的人才會建議：一律使用 factory。
